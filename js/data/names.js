export const PERSONALITIES = ["Hiền lành", "Tham vọng", "Cứng đầu", "Sợ hãi", "Tò mò", "Lãnh đạo"];
...
export const FIRST_NAMES = ["Kael", "Lyra", "Orion", "Nova", "Finn", "Elara", "Jax", "Sia", "Rex", "Mila", "Zane", "Cleo", "Bram", "Aria", "Thor", "Freya", "Zephyr", "Lumi"];
